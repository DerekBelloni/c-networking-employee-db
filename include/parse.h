...
int update_hours(int fd, struct dbheader_t *, struct employee_t *, char *updadtedHrs);
int remove_employee(int fd, struct dbheader_t *, struct employee_t *, char *removestring);
